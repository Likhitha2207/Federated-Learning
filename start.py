...
#first time comment so that we get global_model.keras
...
def getOTPApi(number):
    global session
    session = dict()
    account_sid = 'AC33a919c26d68385fbf8d636bd01bff01'
    auth_token = 'da75738d06732d3490f2f7d583ac02b5'
...
def server_active():
    if(validation1==True):
        ...
        server_ip = '10.10.29.3'  # Replace with your server's local IP address
        server_port = 12347
